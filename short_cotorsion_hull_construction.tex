...
a sequence $l = (l_n)_{n \geq 1}$ such that:
\begin{enumerate}
\item $l_n = \frac{l_1}{n!}$ for all $n \geq 1$
\item $\hat{g}_n - l_n \in G$ for all $n \geq 1$
\end{enumerate}

\textbf{Why this is equivalent to the previous formulation:} If we have $(h_n)$ with 
$h_n \in G$ such that $l_n = \hat{g}_n - h_n$ satisfies $l_n = l_1/n!$, then 
$\hat{g}_n - l_n = h_n \in G$. Conversely, if there exists $l = (l_n)$ with 
$l_n = l_1/n!$ and $\hat{g}_n - l_n \in G$, then setting $h_n = \hat{g}_n - l_n \in G$ 
gives us the previous formulation. This version is cleaner as it directly states 
the existence of the sequence $l$ with the factorial relationship.
