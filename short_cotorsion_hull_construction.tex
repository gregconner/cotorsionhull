...
a sequence $(h_n)_{n \geq 1}$ with $h_n \in G$ such that for all $n \geq 1$:
\begin{enumerate}
\item[(a)] $\hat{g}_1 - h_1 = n! \cdot (\hat{g}_n - h_n)$
\item[(b)] Defining $l_n = \hat{g}_n - h_n$, we have $l_n = \frac{l_1}{n!}$
\end{enumerate}
These are equivalent: (a) says the difference $\hat{g}_1 - h_1$ is divisible by $n!$ 
for all $n$, while (b) expresses this as the sequence $(l_n)$ being determined by 
its first term via division by factorials.
...
\item The remainders $(g_n)$ are compatible: $n \cdot g_m - m \cdot g_n \in G$ 
      for all $n, m \geq 1$.
\item Define $\hat{g}_n = g_{n!}$ for $n \geq 1$. There exists a sequence $(h_n)_{n \geq 1}$ 
      with $h_n \in G$ such that for all $n \geq 1$, either:
      \begin{enumerate}
      \item[(a)] $\hat{g}_1 - h_1 = n! \cdot (\hat{g}_n - h_n)$, or equivalently
      \item[(b)] defining $l_n = \hat{g}_n - h_n$, we have $l_n = \frac{l_1}{n!}$
      \end{enumerate}
