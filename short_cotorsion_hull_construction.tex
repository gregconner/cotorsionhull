...
\begin{enumerate}
\item $l_1 = n! \cdot l_n$ for all $n \geq 1$
...
of $G$. This is equivalent to the formulation with $(h_n)$: if we have $(h_n)$ 
with $h_n \in G$ such that $l_n = \hat{g}_n - h_n$ satisfies $l_1 = n! \cdot l_n$, 
then we get the sequence $l$. Conversely, given $l$ satisfying the conditions, 
setting $h_n = \hat{g}_n - l_n \in G$ gives the $(h_n)$ formulation.
